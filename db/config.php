...
# 'mtt_url' - directory URL where mytinytodo is installed (with trailing slash)
# (ex.: http://site.com/lib/mytinytodo/)
$config['url'] = '';
$config['mtt_url'] = '';
...
# Specify password here to protect your tasks from modification, or leave empty that everyone could
# read/write the to do lists
$config['password'] = "";
...
# due date calendar format: 1 => y-m-d (default), 2 => m/d/y, 3 => d.m.y
